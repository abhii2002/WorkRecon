...
import com.blissvine.workrecon.adapters.BoardItemsAdapter
...
class MainActivity : BaseActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mSharedPreferences = this.getSharedPreferences(Constants.WORKRECON_PREFERENCES, Context.MODE_PRIVATE)
