...
// This base activity is going to be replacement for the app compact activity for our other activities
// Here we will defines several functions and methods so that other classes can inherit from this activity
