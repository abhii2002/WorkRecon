...
//        et_name.setFocusable(false); //to disable it
//
//        imageBtn.setOnClickListener {
//
//            et_name.setFocusableInTouchMode(true); //to enable it
//        }
  ...
  private fun updateUserProfileData(){
        ...
        if(et_name.text.toString() != mUserDetails.mobile.toString()){
